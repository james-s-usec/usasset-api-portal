...
**data** | [**ProjectDto**](ProjectDto.md) |  | [default to undefined]
...
```typescript
import { ProjectsControllerCreate200Response } from '@usasset/api-client';

const instance: ProjectsControllerCreate200Response = {
    success,
    data,
    message,
    timestamp,
