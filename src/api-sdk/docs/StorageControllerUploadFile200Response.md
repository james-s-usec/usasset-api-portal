...
**data** | [**StorageFileDto**](StorageFileDto.md) |  | [default to undefined]
...
```typescript
import { StorageControllerUploadFile200Response } from '@usasset/api-client';

const instance: StorageControllerUploadFile200Response = {
    success,
    data,
    message,
    timestamp,
