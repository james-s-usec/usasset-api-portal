...
**data** | [**PaginatedEquipmentDto**](PaginatedEquipmentDto.md) |  | [default to undefined]
...
```typescript
import { EquipmentControllerFindPaginated200Response } from '@usasset/api-client';

const instance: EquipmentControllerFindPaginated200Response = {
    success,
    data,
    message,
    timestamp,
