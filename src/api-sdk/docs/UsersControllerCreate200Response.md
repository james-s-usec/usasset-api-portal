...
**data** | [**UserDto**](UserDto.md) |  | [default to undefined]
...
```typescript
import { UsersControllerCreate200Response } from '@usasset/api-client';

const instance: UsersControllerCreate200Response = {
    success,
    data,
    message,
    timestamp,
